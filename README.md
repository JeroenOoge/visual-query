...
* Upload a .csv file of "seed papers", which are papers that you would definitely like to include in the review. See the example file caled "exampleSeedPapers.csv".
